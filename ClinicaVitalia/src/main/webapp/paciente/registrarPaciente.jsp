...
<body>
	...
	<div class="container">
		    <br>
		    <h1 class="h1 mb-3 font-weight-normal text-center">Registrar Paciente</h1>
	</div> 
	    <div class="row">
				...
				<form id="frmRegistrarPaciente" action="pacienteServlet" method="post" >
					<div class="row">
				            <div class="col-md-6">
					            ...
					            <div class="form-group">
					    	        <button type="submit" name="opcion" value="reg" class="btn btn-primary mt-3">Registrar</button>          		        
